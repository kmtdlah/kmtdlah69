...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
	let bzz = fs.readFileSync('./vn/help.mp3')
...
┗━━━━━━━━⬣`.trim(),
          ...
          "sections": [
            {
            "title":"⟣───────────❲ LIST MENU HIGH ❳────────────⟢",
              "rows": [
                {
                  "title": `🧾› 𐐪-Semua Perintah-𐑂`,
                  ...
                  "title": "🎙️› 𐐪-Sound Music-𐑂",
                  "description": "Dengar Music Singkat",
                  "rowId": ".? sound"
                }, {
                  "title": "🎙️› 𐐪-Vn Imuet-𐑂",
